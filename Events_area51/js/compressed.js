  ...
  t && Object.deepExtend(m, t),
      ...
      for (var e = 0; e < m.particles.array.length; e++) {
        ...
        if (
          ...
          for (var n = e + 1; n < m.particles.array.length; n++) {
            ...
            m.particles.line_linked.enable && m.fn.interact.linkParticles(t, s),
              m.particles.move.attract.enable &&
                m.fn.interact.attractParticles(t, s),
              m.particles.move.bounce && m.fn.interact.bounceParticles(t, s);
          }
      }
    }),
    ...
    (m.fn.interact.attractParticles = function (e, t) {
      ...
      if (Math.sqrt(a * a + i * i) <= m.particles.line_linked.distance) {
        var n = a / (1e3 * m.particles.move.attract.rotateX),
    ...
    (m.fn.modes.bubbleParticle = function (o) {
      if (
        m.interactivity.events.onhover.enable &&
        isInArray("bubble", m.interactivity.events.onhover.mode)
      ) {
        var e = o.x - m.interactivity.mouse.pos_x,
          t = o.y - m.interactivity.mouse.pos_y,
          a =
            1 -
            (c = Math.sqrt(e * e + t * t)) /
              m.interactivity.modes.bubble.distance;
        ...
        if (c <= m.interactivity.modes.bubble.distance) {
          if (0 <= a && "mousemove" == m.interactivity.status) {
            if (m.interactivity.modes.bubble.size != m.particles.size.value)
              if (m.interactivity.modes.bubble.size > m.particles.size.value) {
                0 <= (s = o.radius + m.interactivity.modes.bubble.size * a) &&
                  (o.radius_bubble = s);
              } else {
                var n = o.radius - m.interactivity.modes.bubble.size,
                  s = o.radius - n * a;
            ...
            if (
              ...
              if (
                ...
                (r = m.interactivity.modes.bubble.opacity * a) > o.opacity &&
        ...
        if (m.tmp.bubble_clicking) {
          (e = o.x - m.interactivity.mouse.click_pos_x),
            (t = o.y - m.interactivity.mouse.click_pos_y);
          ...
          if (e != t)
            if (m.tmp.bubble_duration_end)
              null != a &&
                ...
                "size" == n && (o.radius_bubble = r),
                "opacity" == n && (o.opacity_bubble = r));
            else if (c <= m.interactivity.modes.bubble.distance) {
              if (null != a) var s = a;
              else s = i;
              if (s != e) {
                var r =
              ...
              "size" == n && (o.radius_bubble = void 0),
                "opacity" == n && (o.opacity_bubble = void 0);
        }
    ...
    (m.fn.modes.repulseParticle = function (i) {
      if (
        ...
        var e = i.x - m.interactivity.mouse.pos_x,
          ...
          s = t / a,
          r = clamp(
            (1 / (c = m.interactivity.modes.repulse.distance)) *
              (-1 * Math.pow(a / c, 2) + 1) *
              c *
              100,
            0,
          ...
          o = { x: i.x + n * r, y: i.y + s * r };
        "bounce" == m.particles.move.out_mode
          ? (0 < o.x - i.radius && o.x + i.radius < m.canvas.w && (i.x = o.x),
            0 < o.y - i.radius && o.y + i.radius < m.canvas.h && (i.y = o.y))
          : ((i.x = o.x), (i.y = o.y));
      } else if (
        m.interactivity.events.onclick.enable &&
        isInArray("repulse", m.interactivity.events.onclick.mode)
        ...
        if (
          ...
          var c = Math.pow(m.interactivity.modes.repulse.distance / 6, 3),
    ...
    (m.fn.vendors.drawShape = function (e, t, a, i, n, s) {
      var r = n * s,
        o = n / s,
        c = (180 * (o - 2)) / o,
...
function fullscroll() {
  if (
    ("undefined" == typeof fires && (fires = []),
    "undefined" != typeof svgDoc &&
      null != svgDoc &&
      fires.length < 3 &&
      (fires = svgDoc.getElementsByClassName("fire")),
    scrollHandling.allow)
  ) {
    for (var e = 0; e < fires.length; e++) fires[e].style.display = "block";
    var t = $(fullcont).scrollTop(),
      a = t > lastScrollTop ? "down" : "up";
    (lastScrollTop = t),
      ...
      $.data(
        ...
        "scrollTimer",
        setTimeout(function () {
          for (var e = 0; e < fires.length; e++)
            fires[e].style.display = "none";
        }, 250)
      ),
      "up" == a
        ? rocketsvg.css("transform", "rotate(180deg)")
        : rocketsvg.css("transform", "rotate(0deg)");
    for (var i = fullcont.scrollTop(), n = 0; n < lazyloadImages.length; n++) {
      var s = lazyloadImages[n];
      s.getBoundingClientRect().top < window.innerHeight + i &&
        ((s.src = s.dataset.src), s.classList.remove("lazyimage"));
    }
    var r =
      (100 * i) /
      (childcontparent.height() -
        (reachus.height() - teamscroll.height() - contactshelf.height()));
    $(rocketsvg).css("top", r + "%");
    var o = [0, 20, 50, 75, 100],
      c = [title_link, about_link, sponsor_link, faq_link, contact_link];
    for (e = 0; e < 5; e++)
      Math.abs(r - o[e]) < 12
        ? c[e].addClass("highlighted")
        : c[e].removeClass("highlighted");
    $(fullcont).scrollTop() >= $("#ramanujan").position().top &&
      !triggered &&
      ((triggered = !0),
...
function getOffset(e) {
  for (var t = 0, a = 0; e && !isNaN(e.offsetLeft) && !isNaN(e.offsetTop); )
    (t += e.offsetLeft - e.scrollLeft),
      (a += e.offsetTop - e.scrollTop),
      (e = e.offsetParent);
  return { top: a, left: t };
}
function rocketDrag(e) {}
function get_email() {
  (email_id = document.getElementById("id_email").value), console.log(email_id);
}
(Object.deepExtend = function (e, t) {
  ...
  particlesJS("particles-js", {
    particles: {
      number: { value: 60, density: { enable: !0, value_area: 1100 } },
      color: { value: "#99dfdf" },
      shape: {
        type: "circle",
      ...
      size: {
        value: 2,
        random: !0,
        anim: { enable: !1, speed: 20, size_min: 1.9, sync: !1 },
      },
      line_linked: {
        enable: !0,
        distance: 220,
  ...
  $(document).ready(function () {
    $(window).on("load", function () {
      (preloaderFadeOutTime = 500),
        $(".preloadsvg").fadeOut(preloaderFadeOutTime);
    });
  }),
  $(document).ready(function () {
    if (
      ...
      "undefined" != typeof svgDoc && null != svgDoc)
    ) {
      fires = svgDoc.getElementsByClassName("fire");
      for (var e = 0; e < fires.length; e++) fires[e].style.display = "none";
    }
  }),
  $(document).ready(function () {
    ...
    var n = !1,
      s = document.getElementsByClassName("full-container")[0];
    $(".overlaysvg").mousedown(function () {
      n = !0;
    }),
      $("*").mousemove(function (e) {
        if (n) {
          for (var t = 0; t < fires.length; t++)
            fires[t].style.display = "block";
          var a = window.innerHeight;
          if (0 < e.pageY - 0.05 * a && e.pageY < 0.95 * a) {
            var i = (100 * (e.pageY - 0.05 * a)) / (0.9 * a);
            (sv.style.top = i + "% "),
      ...
      $("*").mouseup(function () {
        n && ((n = !1), (s.style.scrollBehavior = "smooth"));
      });
  });
var TxtType = function (e, t, a) {
  (this.toRotate = t),
    (this.el = e),
    (this.loopNum = 0),
...
if (
  ...
  (window.onload = function () {
    for (
      var e = document.getElementsByClassName("typewrite"), t = 0;
      t < e.length;
      t++
    ) {
      var a = e[t].getAttribute("data-type"),
        i = e[t].getAttribute("data-period");
      a && new TxtType(e[t], JSON.parse(a), i);
    }
  ...
  $(document).ready(function () {
    ...
    $(".email input").on("keyup", function (e) {
      $(this)
        .parent()
        .toggleClass("success", t.test($(this).val())),
        console.log("asd");
    });
  }),
  detectIE())
